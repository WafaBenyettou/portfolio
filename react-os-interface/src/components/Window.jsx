...
function Window({ title, content, onClose, onMinimize, onMaximize, isMinimized, isMaximized }) {
  return (
    <Draggable handle=".handle" cancel=".no-drag">
      <div className={`absolute bg-gray-900 border border-gray-700 shadow-lg rounded-lg ${isMaximized ? 'w-full h-full' : 'min-w-[300px] max-w-[800px]'} ${isMinimized ? 'hidden' : ''} resize overflow-hidden`} style={{ touchAction: 'none' }}>
